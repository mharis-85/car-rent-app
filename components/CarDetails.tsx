                    ...
                    leaveTo='opacity-0 scale-95' 
                     >
                        <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                            <button className=' absolute top-2 right-2 z-10 w-fit p-2 bg-primary-blue rounded-full' type='button' onClick={closeModal} >
                                <Image
                                src={"/close.svg"}
                                alt="close"
                                width={20}
                            ...
                            <div className='flex-1 flex flex-col gap-3'>
                                ...
                                <div className='flex gap-3'>
                                    ...
                                    <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                        <Image alt="car" src={generateCarImageUrl(car,'21')}  fill priority className='object-contain'/>
                                    </div>
                                    <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                            ...
                            <div className='flex-1 flex flex-col gap-2 '>
                                ...
                                <div className='mt-3 flex flex-wrap gap-4 mx-0'>
